  ...
  module Generators
    class Pagination < Generator
      ...
      def generate(site)
         ...
         paginate(site, '/features/lists/index.html', 'lists')
         paginate(site, '/features/series/index.html', 'series-index')
      end
...
#puts all_posts
 ...
 #puts categories       
        for category in categories
          all_posts = site.categories[post.data[category]]
#puts all_posts
          page = site.pages.select do |page|
            path = page.dir + "/" + page.name
