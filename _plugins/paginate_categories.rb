module Jekyll
  ...
  module Generators
    class Pagination < Generator
      ...
      # Returns nothing.
      def generate(site)
        #paginate(site, 'all-posts/index.html','reviews')
        paginate_categories(site, 'reviews/categories/', 'review_index.html', site.categories['reviews'])
      end
